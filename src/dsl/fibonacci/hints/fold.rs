use crate::dsl::fibonacci::hints::fiat_shamir::FiatShamirOutput;
use crate::dsl::fibonacci::hints::prepare::PrepareOutput;
use crate::dsl::fibonacci::hints::quotients::QuotientsOutput;
...
pub fn compute_fold_hints(
    ...
    for &queries_parent in fs_output.queries_parents.iter() {
        ...
        for (proof, commitment) in proofs.iter().zip(fs_output.fri_commitments.iter()) {
