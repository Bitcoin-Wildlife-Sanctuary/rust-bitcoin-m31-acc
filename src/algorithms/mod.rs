...
use bitcoin_circle_stark::channel::Sha256ChannelGadget;
...
pub fn verify_pow(hash: &mut HashVar, n_bits: u32, nonce: u64) -> Result<()> {
...
fn verify_pow_gadget(_: &mut Stack, options: &Options) -> Result<Script> {
